...
function validateSettings(settings) {
    ...
    if (!_.isNumber(settings.max_players) || settings.max_players !== settings.max_players | 0 || settings.max_players <= 0)
        throw new Error('Maximum player count must be a positive integer');
}
